...
function setUsername() {
  myUsername = document.getElementById("txtNombre").value;
...
function handleUserlistMsg(msg) {
  ...
  usuariosConectados = msg.users;
  const usuarioRemoto = usuariosConectados.find(usuario => usuario !== myUsername);
  if (usuarioRemoto) {
    targetUsername = usuarioRemoto;
    joinCall();
    setearTargetUsername(targetUsername);
  }
...
async function joinCall() {
  log("Preparando para sumarse a la llamada.");
  if (myPeerConnection) {
    alert("Ya existe una llamada en curso!");
  } else {
